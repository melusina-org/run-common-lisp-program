;;;; testsuite.lisp — Testsuite to Run Common Lisp Program
...
(require '#:org.melusina.github-action.run-common-lisp-program)

(defpackage #:org.melusina.github-action.run-common-lisp-program/testsuite
  (:use #:common-lisp)
  (:local-nicknames
...
(in-package #:org.melusina.github-action.run-common-lisp-program/testsuite)
